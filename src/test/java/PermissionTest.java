...
public class PermissionTest extends TestBase {
    ...
    public void testFileAuth() throws Exception {
        ...
        permissions.add(new FilePermission(TMPDIR + "testOpenWriteReadAndCloseAsync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testOpenWriteReadAndCloseAsync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testUnlinkSync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testUnlinkSync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testUnlinkSync.txt", "delete"));
        permissions.add(new FilePermission(TMPDIR + "testUnlinkAsync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testUnlinkAsync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testUnlinkAsync.txt", "delete"));
        permissions.add(new FilePermission(TMPDIR + "testMkdirRmdirSync", "write"));
        permissions.add(new FilePermission(TMPDIR + "testMkdirRmdirSync", "delete"));
        permissions.add(new FilePermission(TMPDIR + "testMkdirRmdirAsync", "write"));
        permissions.add(new FilePermission(TMPDIR + "testMkdirRmdirAsync", "delete"));
        permissions.add(new FilePermission("src", "read"));
        permissions.add(new FilePermission(TMPDIR + "testRenameSync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testRenameSync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testRenameSync-new.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testRenameSync-new.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testRenameSync-new.txt", "delete"));
        permissions.add(new FilePermission(TMPDIR + "testRenameAsync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testRenameAsync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testRenameAsync-new.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testFtruncateSync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testFtruncateSync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testFtruncateSync.txt", "delete"));
        permissions.add(new FilePermission(TMPDIR + "testFtruncateAsync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testFtruncateAsync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testLinkSync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testLinkSync.txt", "read"));
        permissions.add(new LinkPermission("hard"));
        permissions.add(new FilePermission(TMPDIR + "testLinkSync2.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testLinkSync2.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testLinkSync.txt", "delete"));
        permissions.add(new FilePermission(TMPDIR + "testLinkSync2.txt", "delete"));
        permissions.add(new FilePermission(TMPDIR + "testLinkAsync.txt", "write"));
        permissions.add(new FilePermission(TMPDIR + "testLinkAsync.txt", "read"));
        permissions.add(new FilePermission(TMPDIR + "testLinkAsync2.txt", "write"));
