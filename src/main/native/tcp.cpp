 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_net_java_libuv_handles_TCPHandle__1new
 ...
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_TCPHandle__1bind
 ...
 * Signature: (JLjava/lang/String;I)I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_TCPHandle__1bind6
  (JNIEnv *env, jobject that, jlong tcp, jstring host, jint port) {
 ...
 * Signature: (JLjava/lang/String;I)I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_TCPHandle__1open
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_TCPHandle__1no_1delay
 ...
 * Signature: (JII)I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_TCPHandle__1keep_1alive
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_TCPHandle__1simultaneous_1accepts
  (JNIEnv *env, jobject that, jlong tcp, jint enable) {
