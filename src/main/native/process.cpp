 ...
 */
JNIEXPORT jstring JNICALL Java_net_java_libuv_LibUV__1exe_1path
 ...
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_net_java_libuv_LibUV__1cwd
  (JNIEnv *env, jclass cls) {
 ...
 */
JNIEXPORT void JNICALL Java_net_java_libuv_LibUV__1chdir
 ...
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_net_java_libuv_LibUV__1getTitle
  (JNIEnv *env, jclass cls) {
 ...
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void JNICALL Java_net_java_libuv_LibUV__1setTitle
 ...
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_LibUV__1kill
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_LibUV__1rss
  (JNIEnv *env, jclass cls) {
