...
/*
 * Class:     net_java_libuv_handles_PipeHandle
 * Method:    _new
 * Signature: (JZ)J
 */
JNIEXPORT jlong JNICALL Java_net_java_libuv_handles_PipeHandle__1new
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_PipeHandle__1open
 ...
 */
JNIEXPORT jint JNICALL Java_net_java_libuv_handles_PipeHandle__1bind
