 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_net_java_libuv_handles_Handle__1ref
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_net_java_libuv_handles_Handle__1unref
  (JNIEnv *env, jobject that, jlong ptr) {
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_net_java_libuv_handles_Handle__1closing
  (JNIEnv *env, jobject that, jlong ptr) {
